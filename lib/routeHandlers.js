...
//checks Dashboard
routeHandlers.ordersList = function (data, callback) {
  // Reject any request that isn't a GET
  if (data.method == 'get') {
    // Prepare data for interpolation
    const templateData = {
    ...
    // Read in a template as a string
    aux.getTemplate('ordersList', templateData, function (err, str) {
      if (!err && str) {
        // Add the universal header and footer
        aux.addUniversalTemplates(str, templateData, function (err, str) {
          if (!err && str) {
...
//edit a check
routeHandlers.checkout = function (data, callback) {
  // Reject any request that isn't a GET
  if (data.method == 'get') {
    // Prepare data for interpolation
    const templateData = {
    ...
    // Read in a template as a string
    aux.getTemplate('checkout', templateData, function (err, str) {
      if (!err && str) {
        // Add the universal header and footer
        aux.addUniversalTemplates(str, templateData, function (err, str) {
          if (!err && str) {
